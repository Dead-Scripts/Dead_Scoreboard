...
AddEventHandler('playerSpawned', function()
	if not alreadySet then 
		TriggerServerEvent('Dead-ServerList:SetupImg')
		alreadySet = true;
	end 
end)
alreadySet = false;
...
playerNames = {}
discordNames = {}
RegisterNetEvent('Dead-ServerList:DiscordUpdate')
AddEventHandler('Dead-ServerList:DiscordUpdate', function(players)
	discordNames = {};
...
RegisterNetEvent('Dead-ServerList:PlayerUpdate')
AddEventHandler('Dead-ServerList:PlayerUpdate', function(players)
	playerNames = {};
...
RegisterNetEvent('Dead-ServerList:PingUpdate')
AddEventHandler('Dead-ServerList:PingUpdate', function(pingList)
	pingss = {};
...
RegisterNetEvent('Dead-ServerList:ClientUpdate')
AddEventHandler('Dead-ServerList:ClientUpdate', function(avas)
	avatarss = {};
